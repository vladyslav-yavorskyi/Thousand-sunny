...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/select/select.js":[function(require,module,exports) {
"use strict";
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    key: "selected",
    value: function selected(cont, id) {
      this.value.textContent = cont;
      this.el.querySelectorAll('[data-type="item"]').forEach(function (e) {
...
var select_1 = new _select.Select("#select_1");
var select_2 = new _select.Select("#select_2");
var select_3 = new _select.Select("#select_3");
window.s = select;
},{"./select/select":"scripts/select/select.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
